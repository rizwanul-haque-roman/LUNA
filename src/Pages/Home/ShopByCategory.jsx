  ...
  return (
    <div className="mt-4 lg:mt-16" data-aos="zoom-in" data-aos-duration="1500">
      ...
      <div className="grid grid-cols-3 lg:grid-cols-5 gap-4 justify-items-center mt-4 lg:mt-16">
        <a href="/face" data-aos="flip-left" data-aos-duration="1000">
          <img
        ...
        <a href="/lips" data-aos="flip-left" data-aos-duration="1000">
          <img
            className="rounded-full w-[100px] lg:w-[200px] h-[100px] lg:h-[200px]"
            src="/lips.webp"
            alt=""
        ...
        <a href="/eyes" data-aos="flip-left" data-aos-duration="1000">
          <img
            className="rounded-full w-[100px] lg:w-[200px] h-[100px] lg:h-[200px]"
            src="/eyes.webp"
            alt=""
        ...
        <a href="/tools" data-aos="flip-left" data-aos-duration="1000">
          <img
            className="rounded-full w-[100px] lg:w-[200px] h-[100px] lg:h-[200px]"
            src="/tools.webp"
            alt=""
        ...
        <a href="/nails" data-aos="flip-left" data-aos-duration="1000">
          <img
            className="rounded-full w-[100px] lg:w-[200px] h-[100px] lg:h-[200px]"
            src="/nails.webp"
            alt=""
